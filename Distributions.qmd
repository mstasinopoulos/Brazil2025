...
-   $\int_{R_Y} f(y) \; dy=1$ (continuous)

-   $\sum_{y\in R_Y} f(y)=\sum_{y \in R_Y} P(Y=y)=1$ (discrete)

-   $\int_{R_{1}} f(y)\, dy + \sum_{y \in R_{2}} f(y) = 1$ (mixed).
...
![tobit 1](tobit0Inf-1.png)

## generalized TOBIT

![tobit 2](tobit0Inf-2.png)
